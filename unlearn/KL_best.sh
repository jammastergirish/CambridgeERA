...
EPOCHS=1 LR=1.3e-05 BATCH_SIZE=16 \
    ALPHA=200.0 STEERING_COEFF=10.0 LAYER_ID="13,14,15" \
    ./unlearn/run_unlearn.sh cb
...
EPOCHS=1 LR=2e-05 BATCH_SIZE=4 RETAIN_WEIGHT=5.0 \
    ./unlearn/run_unlearn.sh ga
...
EPOCHS=1 LR=1e-05 BATCH_SIZE=4 FORGET_WEIGHT=1.0 \
    ./unlearn/run_unlearn.sh grad_diff
...
EPOCHS=1 LR=2e-05 BATCH_SIZE=4 WT_NOISE_STD=0.0001 \
    ./unlearn/run_unlearn.sh wt_dist
