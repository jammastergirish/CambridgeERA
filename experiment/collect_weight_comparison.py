...
from utils import init_wandb, log_csv_as_table, finish_wandb
...
def main():
    ...
    init_wandb("collect_weight_comparison", args)
    ...
    # --- Output (write directly to --outdir, matching collect_param_stats.py) ---
    outdir = args.outdir
