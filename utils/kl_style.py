...
def set_plotting_style(style='darkgrid', dpi=None):
    ...
    # Font preference: STIXGeneral (modernized Computer Modern, full Unicode support)
    # Fallback chain: STIXGeneral → Times → matplotlib default
    ...
    # If neither is available, let matplotlib use its default
